...
from tmdb_utils import add_popular_movies_to_db
...
def update_profile(user_id):
    ...
    db.session.commit()
    print(f"DEBUG - Profil sauvegardé: citation={profile.citation}, acteur={profile.acteur}")
